...
utils.setChildren = function (comp, children, callback) {
  ...
  for (var i = 0; i < argLen; i++) {
    var item = children[i];
    if (Array.isArray(item)) loadReactTreeEx_(bChild, item, W.$staticNodes, W.$cachedClass);else if (typeof item == 'string') bChild.push(React.createElement(comp.props['childInline.'] ? Span__ : P__, { 'html.': item })); // item maybe ''
    else if (React.isValidElement(item)) bChild.push(item);
            ...
            if (!fn) {
              ...
              if (fn2) {
                try {
                  ...
                  if (!forChild) forChild = null;else if (!React.isValidElement(forChild) && !Array.isArray(forChild) && typeof forChild != 'string') forChild = null;
                } catch (e) {
...
function dumpReactTree_(bRet, wdgt, sPath) {
  ...
  if (sLink !== undefined) {
    ...
    // else, system error, unknown format
      ...
      objGui.dataset.forEach(function (item) {
...
var TWidget_ = function () {
  ...
  _createClass2(TWidget_, [{
    ...
    value: function setEvent(evSet) {
      ...
      for (var i = 0, sKey; sKey = b[i]; i++) {
        ...
        if (typeof fn == 'function') {
          if (!eventset[sKey2]) eventset[sKey2] = fn.bind(this);
          this[sKey] = fn;
        }
      }
    }
          ...
          if (tp == 'string') {
            if (item == '$id__') {
              ...
              if (ctrlExprCmd_.indexOf(item) >= 0) {
                ...
                if (item == 'children') {
                  if (this.props.hasOwnProperty('for.index')) {
      ...
      this.defineDual('childNumId', function (newNumId, oldNumId) {
        ...
        bComp.forEach(function (child, iPos) {
          ...
          if (childInline2 !== undefined) {
            ...
            compIdx[keyid] = iPos;
            if (!isOld) bComp[iPos] = React.cloneElement(child, { key: sKey }); // not pass 'keyid.' to avoid react warning
            return;
          }
    ...
    value: function setChild() {
      ...
      for (var i = bComp.length - 1; i >= 0; i--) {
        ...
        if (sKey_) {
          ...
          if (hasClass_(child.props.className, 'rewgt-static')) bComp[i] = React.cloneElement(child, { key: sKey_ });else {
    ...
    value: function prepareState() {
      ...
      if (hiAuto) delete dStyle.height;else dStyle.height = cssHi + iPadT + iPadB + iBrdT + iBrdB + 'px';
  ...
  function resetNodes(comp, value, oldValue) {
    ...
    for (var i = value.length - 1; i >= 0; i--) {
      ...
      if (typeof ele == 'string') {
        ...
        if (ele.props['keyid.'] !== sKey) ele = item[1] = React.cloneElement(ele, { key: sKey, 'keyid.': sKey });
        bNewKey.unshift(sKey);
        bNewEle.unshift(ele);
      } else {
        if (Array.isArray(ele) && ele[0]) {
          ...
          if (ele) {
            if (ele.props['keyid.'] !== sKey) ele = React.cloneElement(ele, { key: sKey, 'keyid.': sKey });
            item[1] = ele;
            bNewKey.unshift(sKey);
            bNewEle.unshift(ele);
            continue; // success
...
var TDiv_ = function (_TUnit_3) {
  ...
  function TDiv_(name, desc) {
    ...
    _this8._silentProp.push('tagName.'); // _statedProp no change
...
var THiddenDiv_ = function (_TDiv_) {
  _inherits(THiddenDiv_, _TDiv_);

  function THiddenDiv_(name, desc) {
    _classCallCheck(this, THiddenDiv_);

    var _this9 = _possibleConstructorReturn(this, (THiddenDiv_.__proto__ || Object.getPrototypeOf(THiddenDiv_)).call(this, name || 'HiddenDiv', desc));

    _this9._defaultProp.width = undefined;
...
var TArticle_ = function (_TDiv_2) {
  _inherits(TArticle_, _TDiv_2);
...
var TSection_ = function (_TDiv_3) {
  _inherits(TSection_, _TDiv_3);
...
var THeader_ = function (_TDiv_4) {
  _inherits(THeader_, _TDiv_4);
...
var TFooter_ = function (_TDiv_5) {
  _inherits(TFooter_, _TDiv_5);
...
var TAside_ = function (_TDiv_6) {
  _inherits(TAside_, _TDiv_6);
...
var TNav_ = function (_TDiv_7) {
  _inherits(TNav_, _TDiv_7);
...
var TMain_ = function (_TDiv_8) {
  _inherits(TMain_, _TDiv_8);
...
var TP_ = function (_TUnit_4) {
  ...
  function TP_(name, desc) {
    ...
    var _this17 = _possibleConstructorReturn(this, (TP_.__proto__ || Object.getPrototypeOf(TP_)).call(this, name || 'P', desc));

    _this17._silentProp.push('tagName.'); // _statedProp no change
    _this17._defaultProp.width = undefined;
    _this17._defaultProp.height = undefined;
    _this17._defaultProp.margin = TPara_margin_.slice(0);
    _this17._htmlText = true;
    return _this17;
  }
...
var TNoscript_ = function (_TP_) {
  ...
  function TNoscript_(name, desc) {
    ...
    var _this18 = _possibleConstructorReturn(this, (TNoscript_.__proto__ || Object.getPrototypeOf(TNoscript_)).call(this, name || 'Noscript', desc));

    delete _this18._defaultProp.margin;
    return _this18;
  }
...
var TFieldset_ = function (_TP_2) {
  ...
  function TFieldset_(name, desc) {
    ...
    var _this19 = _possibleConstructorReturn(this, (TFieldset_.__proto__ || Object.getPrototypeOf(TFieldset_)).call(this, name || 'Fieldset', desc));

    _this19._defaultProp.padding = TFieldset_padding_.slice(0);
    _this19._defaultProp.borderWidth = TFieldset_border_width_.slice(0);
    return _this19;
  }
...
var TUl_ = function (_TP_4) {
  ...
  function TUl_(name, desc) {
    ...
    var _this21 = _possibleConstructorReturn(this, (TUl_.__proto__ || Object.getPrototypeOf(TUl_)).call(this, name || 'Ul', desc));

    _this21._defaultProp.padding = TUl_padding_.slice(0); // _statedProp, _silentProp no change
    return _this21;
  }
...
var TOl_ = function (_TP_5) {
  ...
  function TOl_(name, desc) {
    ...
    var _this22 = _possibleConstructorReturn(this, (TOl_.__proto__ || Object.getPrototypeOf(TOl_)).call(this, name || 'Ol', desc));

    _this22._defaultProp.padding = TUl_padding_.slice(0); // _statedProp, _silentProp no change
    return _this22;
  }
...
var TIframe_ = function (_TP_16) {
  ...
  function TIframe_(name, desc) {
    ...
    var _this33 = _possibleConstructorReturn(this, (TIframe_.__proto__ || Object.getPrototypeOf(TIframe_)).call(this, name || 'Iframe', desc));

    _this33._defaultProp.margin = TIframe_margin_.slice(0);
...
var TBlockquote_ = function (_TP_17) {
  _inherits(TBlockquote_, _TP_17);

  function TBlockquote_(name, desc) {
    _classCallCheck(this, TBlockquote_);

    var _this34 = _possibleConstructorReturn(this, (TBlockquote_.__proto__ || Object.getPrototypeOf(TBlockquote_)).call(this, name || 'Blockquote', desc));

    _this34._defaultProp.padding = TBlockquote_padding_.slice(0);
    return _this34;
  }
...
var TTable_ = function (_TP_18) {
  _inherits(TTable_, _TP_18);

  function TTable_(name, desc) {
    _classCallCheck(this, TTable_);

    var _this35 = _possibleConstructorReturn(this, (TTable_.__proto__ || Object.getPrototypeOf(TTable_)).call(this, name || 'Table', desc));
...
var TCaption_ = function (_TP_19) {
  _inherits(TCaption_, _TP_19);
...
var TCol_ = function (_TP_20) {
  _inherits(TCol_, _TP_20);
...
var TColgroup_ = function (_TP_21) {
  _inherits(TColgroup_, _TP_21);
...
var TTd_ = function (_TP_22) {
  _inherits(TTd_, _TP_22);
...
var TTbody_ = function (_TP_23) {
  _inherits(TTbody_, _TP_23);

  function TTbody_(name, desc) {
    _classCallCheck(this, TTbody_);

    var _this40 = _possibleConstructorReturn(this, (TTbody_.__proto__ || Object.getPrototypeOf(TTbody_)).call(this, name || 'Tbody', desc));

    _this40._defaultProp.margin = TBody_margin_.slice(0);
    _this40._htmlText = false;
    return _this40;
  }
...
var TThead_ = function (_TP_24) {
  _inherits(TThead_, _TP_24);
...
var TTfoot_ = function (_TP_25) {
  _inherits(TTfoot_, _TP_25);
...
var TTh_ = function (_TP_26) {
  _inherits(TTh_, _TP_26);

  function TTh_(name, desc) {
    _classCallCheck(this, TTh_);

    var _this43 = _possibleConstructorReturn(this, (TTh_.__proto__ || Object.getPrototypeOf(TTh_)).call(this, name || 'Th', desc));

    _this43._defaultProp.margin = ThTr_margin_.slice(0);
    _this43._htmlText = false;
    return _this43;
  }
...
var TTr_ = function (_TP_27) {
  _inherits(TTr_, _TP_27);

  function TTr_(name, desc) {
    _classCallCheck(this, TTr_);

    var _this44 = _possibleConstructorReturn(this, (TTr_.__proto__ || Object.getPrototypeOf(TTr_)).call(this, name || 'Tr', desc));

    _this44._defaultProp.margin = ThTr_margin_.slice(0);
    _this44._htmlText = false;
    return _this44;
  }
...
var THgroup_ = function (_TP_28) {
  _inherits(THgroup_, _TP_28);
...
var TH1_ = function (_TP_29) {
  _inherits(TH1_, _TP_29);
...
var TH2_ = function (_TP_30) {
  _inherits(TH2_, _TP_30);
...
var TH3_ = function (_TP_31) {
  _inherits(TH3_, _TP_31);
...
var TH4_ = function (_TP_32) {
  _inherits(TH4_, _TP_32);
...
var TH5_ = function (_TP_33) {
  _inherits(TH5_, _TP_33);
...
var TH6_ = function (_TP_34) {
  _inherits(TH6_, _TP_34);
...
var THr_ = function (_TP_35) {
  _inherits(THr_, _TP_35);

  function THr_(name, desc) {
    _classCallCheck(this, THr_);

    var _this52 = _possibleConstructorReturn(this, (THr_.__proto__ || Object.getPrototypeOf(THr_)).call(this, name || 'Hr', desc));

    _this52._defaultProp.width = 0.9999;
    _this52._defaultProp.borderWidth = THr_border_width_.slice(0);
...
var TPre_ = function (_TP_36) {
  _inherits(TPre_, _TP_36);
...
var TSpan_ = function (_TWidget_4) {
  ...
  function TSpan_(name, desc) {
    ...
    var _this54 = _possibleConstructorReturn(this, (TSpan_.__proto__ || Object.getPrototypeOf(TSpan_)).call(this, name || 'Span', desc));

    _this54._statedProp = [];
    _this54._silentProp = ['className', 'hookTo.', 'keyid.', 'childInline.', 'tagName.'];
    _this54._defaultProp = { width: undefined, height: undefined }; // 'html.' default is not passed, suggest not use width/height, but if used also OK
    _this54._htmlText = true; // use 'html.'
    return _this54;
  }
      ...
      this.defineDual('childNumId', function (newNumId, oldNumId) {
        ...
        bComp.forEach(function (child, iPos) {
          ...
          if (childInline2 !== undefined) {
            ...
            compIdx[keyid] = iPos;
            if (!isOld) bComp[iPos] = React.cloneElement(child, { key: sKey }); // not pass 'keyid.'
            return;
          }
...
var TBr_ = function (_TSpan_2) {
  _inherits(TBr_, _TSpan_2);

  function TBr_(name, desc) {
    _classCallCheck(this, TBr_);

    var _this56 = _possibleConstructorReturn(this, (TBr_.__proto__ || Object.getPrototypeOf(TBr_)).call(this, name || 'Br', desc));

    _this56._htmlText = false;
    return _this56;
  }
...
var TA_ = function (_TSpan_3) {
  _inherits(TA_, _TSpan_3);
...
var TQ_ = function (_TSpan_4) {
  _inherits(TQ_, _TSpan_4);
...
var TAbbr_ = function (_TSpan_5) {
  _inherits(TAbbr_, _TSpan_5);
...
var TSource_ = function (_TSpan_7) {
  _inherits(TSource_, _TSpan_7);
...
var TTrack_ = function (_TSpan_8) {
  _inherits(TTrack_, _TSpan_8);
...
var TBdi_ = function (_TSpan_9) {
  _inherits(TBdi_, _TSpan_9);
...
var TBdo_ = function (_TSpan_10) {
  _inherits(TBdo_, _TSpan_10);
...
var TData_ = function (_TSpan_11) {
  _inherits(TData_, _TSpan_11);
...
var TMark_ = function (_TSpan_12) {
  _inherits(TMark_, _TSpan_12);
...
var TWbr_ = function (_TSpan_13) {
  _inherits(TWbr_, _TSpan_13);
...
var TButton_ = function (_TSpan_14) {
  _inherits(TButton_, _TSpan_14);
...
var TTextarea_ = function (_TSpan_15) {
  _inherits(TTextarea_, _TSpan_15);
...
var TProgress_ = function (_TSpan_16) {
  _inherits(TProgress_, _TSpan_16);
...
var TImg_ = function (_TSpan_17) {
  _inherits(TImg_, _TSpan_17);

  function TImg_(name, desc) {
    _classCallCheck(this, TImg_);

    var _this71 = _possibleConstructorReturn(this, (TImg_.__proto__ || Object.getPrototypeOf(TImg_)).call(this, name || 'Img', desc));

    _this71._htmlText = false;
    return _this71;
  }
...
var TVideo_ = function (_TSpan_18) {
  _inherits(TVideo_, _TSpan_18);
...
var TCanvas_ = function (_TSpan_19) {
  _inherits(TCanvas_, _TSpan_19);
...
var TPicture_ = function (_TSpan_20) {
  _inherits(TPicture_, _TSpan_20);
...
var TMap_ = function (_TSpan_21) {
  _inherits(TMap_, _TSpan_21);
...
var TArea_ = function (_TSpan_22) {
  _inherits(TArea_, _TSpan_22);
...
var TTime_ = function (_TSpan_23) {
  _inherits(TTime_, _TSpan_23);
...
var TOutput_ = function (_TSpan_24) {
  _inherits(TOutput_, _TSpan_24);
...
var TInput_ = function (_TSpan_25) {
  _inherits(TInput_, _TSpan_25);

  function TInput_(name, desc) {
    _classCallCheck(this, TInput_);

    var _this79 = _possibleConstructorReturn(this, (TInput_.__proto__ || Object.getPrototypeOf(TInput_)).call(this, name || 'Input', desc));

    _this79._htmlText = false;
    return _this79;
  }
...
var TKeygen_ = function (_TSpan_26) {
  _inherits(TKeygen_, _TSpan_26);
...
var TLabel_ = function (_TSpan_27) {
  _inherits(TLabel_, _TSpan_27);
...
var TLegend_ = function (_TSpan_28) {
  _inherits(TLegend_, _TSpan_28);
...
var TSub_ = function (_TSpan_29) {
  _inherits(TSub_, _TSpan_29);
...
var TSup_ = function (_TSpan_30) {
  _inherits(TSup_, _TSpan_30);
...
var TSelect_ = function (_TSpan_31) {
  _inherits(TSelect_, _TSpan_31);
...
var TOptgroup_ = function (_TSpan_32) {
  _inherits(TOptgroup_, _TSpan_32);
...
var TOption_ = function (_TSpan_33) {
  _inherits(TOption_, _TSpan_33);
...
var TB_ = function (_TSpan_34) {
  _inherits(TB_, _TSpan_34);
...
var TI_ = function (_TSpan_35) {
  _inherits(TI_, _TSpan_35);
...
var TS_ = function (_TSpan_36) {
  _inherits(TS_, _TSpan_36);
...
var TU_ = function (_TSpan_37) {
  _inherits(TU_, _TSpan_37);
...
var TIns_ = function (_TSpan_38) {
  _inherits(TIns_, _TSpan_38);
...
var TDel_ = function (_TSpan_39) {
  _inherits(TDel_, _TSpan_39);
...
var TCode_ = function (_TSpan_40) {
  _inherits(TCode_, _TSpan_40);
...
var TVar_ = function (_TSpan_41) {
  _inherits(TVar_, _TSpan_41);
...
var TSummary_ = function (_TSpan_42) {
  _inherits(TSummary_, _TSpan_42);
...
var TEm_ = function (_TSpan_43) {
  _inherits(TEm_, _TSpan_43);
...
var TStrong_ = function (_TSpan_44) {
  _inherits(TStrong_, _TSpan_44);
...
var TBig_ = function (_TSpan_45) {
  _inherits(TBig_, _TSpan_45);
...
var TSmall_ = function (_TSpan_46) {
  _inherits(TSmall_, _TSpan_46);
...
var TDfn_ = function (_TSpan_47) {
  _inherits(TDfn_, _TSpan_47);
...
var TSamp_ = function (_TSpan_48) {
  _inherits(TSamp_, _TSpan_48);
...
var TKdb_ = function (_TSpan_49) {
  _inherits(TKdb_, _TSpan_49);
...
var TCite_ = function (_TSpan_50) {
  _inherits(TCite_, _TSpan_50);
...
var TDialog_ = function (_TSpan_51) {
  _inherits(TDialog_, _TSpan_51);
...
var TMeter_ = function (_TSpan_52) {
  _inherits(TMeter_, _TSpan_52);
...
var TEmbed_ = function (_TSpan_53) {
  _inherits(TEmbed_, _TSpan_53);
...
var TObject_ = function (_TSpan_54) {
  _inherits(TObject_, _TSpan_54);
...
var TParam_ = function (_TSpan_55) {
  _inherits(TParam_, _TSpan_55);
...
var TRuby_ = function (_TSpan_56) {
  _inherits(TRuby_, _TSpan_56);
...
var TRp_ = function (_TSpan_57) {
  _inherits(TRp_, _TSpan_57);
...
var TRt_ = function (_TSpan_58) {
  _inherits(TRt_, _TSpan_58);
...
var TNavPanel_ = function (_TPanel_3) {
  ...
  function TNavPanel_(name, desc) {
    ...
    var _this114 = _possibleConstructorReturn(this, (TNavPanel_.__proto__ || Object.getPrototypeOf(TNavPanel_)).call(this, name || 'NavPanel', desc));

    _this114._silentProp.push('isNavigator.');
    return _this114;
  }
...
var TNavDiv_ = function (_TNavPanel_) {
  ...
  function TNavDiv_(name, desc) {
    ...
    var _this115 = _possibleConstructorReturn(this, (TNavDiv_.__proto__ || Object.getPrototypeOf(TNavDiv_)).call(this, name || 'NavDiv', desc));

    _this115._silentProp.push('tagName.');
...
var TGroundPanel_ = function (_TPanel_4) {
  ...
  function TGroundPanel_(name, desc) {
    ...
    var _this116 = _possibleConstructorReturn(this, (TGroundPanel_.__proto__ || Object.getPrototypeOf(TGroundPanel_)).call(this, name || 'GroundPanel', desc));

    _this116._silentProp.push('isPlayground.');
    _this116._defaultProp.height = undefined;
    _this116._defaultProp.minHeight = 20;
    return _this116;
  }
...
var TGroundDiv_ = function (_TUnit_5) {
  ...
  function TGroundDiv_(name, desc) {
    ...
    var _this117 = _possibleConstructorReturn(this, (TGroundDiv_.__proto__ || Object.getPrototypeOf(TGroundDiv_)).call(this, name || 'GroundDiv', desc));

    _this117._silentProp.push('tagName.', 'isPlayground.');
    _this117._defaultProp.height = undefined;
    _this117._defaultProp.minHeight = 20;
    _this117._htmlText = true;
    return _this117;
  }
...
var TOptSpan_ = function (_TSpan_59) {
  _inherits(TOptSpan_, _TSpan_59);

  function TOptSpan_(name, desc) {
    _classCallCheck(this, TOptSpan_);

    var _this118 = _possibleConstructorReturn(this, (TOptSpan_.__proto__ || Object.getPrototypeOf(TOptSpan_)).call(this, name || 'OptSpan', desc));

    _this118._silentProp.push('isOption.');
    _this118._defaultProp['data-checked'] = '';
    return _this118;
  }
...
var TOptImg_ = function (_TOptSpan_2) {
  ...
  function TOptImg_(name, desc) {
    ...
    var _this120 = _possibleConstructorReturn(this, (TOptImg_.__proto__ || Object.getPrototypeOf(TOptImg_)).call(this, name || 'OptImg', desc));

    _this120._htmlText = false;
    return _this120;
  }
...
var TOptOption_ = function (_TOptSpan_4) {
  ...
  function TOptOption_(name, desc) {
    ...
    var _this122 = _possibleConstructorReturn(this, (TOptOption_.__proto__ || Object.getPrototypeOf(TOptOption_)).call(this, name || 'OptOption', desc));

    _this122._silentProp.push('selected'); // not save 'selected', suggest only using 'data-checked'
    return _this122;
  }
  ...
  _createClass2(TOptOption_, [{
    ...
    value: function getInitialState() {
      ...
      this.defineDual('data-checked', function (value, oldValue) {
        ...
        if (this.props.hasOwnProperty('selected')) this.state.selected = sValue; // avoid using duals.selected = xx
...
var TOptDiv_ = function (_TDiv_9) {
  _inherits(TOptDiv_, _TDiv_9);

  function TOptDiv_(name, desc) {
    _classCallCheck(this, TOptDiv_);

    var _this123 = _possibleConstructorReturn(this, (TOptDiv_.__proto__ || Object.getPrototypeOf(TOptDiv_)).call(this, name || 'OptDiv', desc));

    _this123._silentProp.push('isOption.');
    _this123._defaultProp['data-checked'] = '';
    return _this123;
  }
...
var TOptLi_ = function (_TP_37) {
  _inherits(TOptLi_, _TP_37);

  function TOptLi_(name, desc) {
    _classCallCheck(this, TOptLi_);

    var _this124 = _possibleConstructorReturn(this, (TOptLi_.__proto__ || Object.getPrototypeOf(TOptLi_)).call(this, name || 'OptLi', desc));

    _this124._silentProp.push('isOption.');
    _this124._defaultProp['data-checked'] = '';
    return _this124;
  }
...
var TOptInput_ = function (_TOptSpan_5) {
  ...
  function TOptInput_(name, desc) {
    ...
    var _this125 = _possibleConstructorReturn(this, (TOptInput_.__proto__ || Object.getPrototypeOf(TOptInput_)).call(this, name || 'OptInput', desc)); // input.type: checkbox radio button image reset submit


    _this125._htmlText = false;
    return _this125;
  }
...
var TTempPanel_ = function (_TPanel_5) {
  ...
  function TTempPanel_(name, desc) {
    ...
    var _this126 = _possibleConstructorReturn(this, (TTempPanel_.__proto__ || Object.getPrototypeOf(TTempPanel_)).call(this, name || 'TempPanel', desc));

    _this126._silentProp.push('isTemplate.', 'data-temp.type');
    return _this126;
  }
...
var TTempDiv_ = function (_TUnit_6) {
  ...
  function TTempDiv_(name, desc) {
    ...
    var _this127 = _possibleConstructorReturn(this, (TTempDiv_.__proto__ || Object.getPrototypeOf(TTempDiv_)).call(this, name || 'TempDiv', desc));

    _this127._silentProp.push('isTemplate.', 'tagName.', 'data-temp.type');
    _this127._htmlText = true;
    return _this127;
  }
...
var TTempSpan_ = function (_TSpan_60) {
  _inherits(TTempSpan_, _TSpan_60);

  function TTempSpan_(name, desc) {
    _classCallCheck(this, TTempSpan_);

    var _this128 = _possibleConstructorReturn(this, (TTempSpan_.__proto__ || Object.getPrototypeOf(TTempSpan_)).call(this, name || 'TempSpan', desc));

    _this128._silentProp.push('isTemplate.', 'data-temp.type');
    return _this128;
  }
...
var TRefDiv_ = function (_TUnit_7) {
  ...
  function TRefDiv_(name, desc) {
    ...
    var _this129 = _possibleConstructorReturn(this, (TRefDiv_.__proto__ || Object.getPrototypeOf(TRefDiv_)).call(this, name || 'RefDiv', desc));

    _this129._silentProp.push('isReference.');
    _this129._htmlText = true;
    return _this129;
  }
...
var TRefSpan_ = function (_TSpan_61) {
  _inherits(TRefSpan_, _TSpan_61);

  function TRefSpan_(name, desc) {
    _classCallCheck(this, TRefSpan_);

    var _this130 = _possibleConstructorReturn(this, (TRefSpan_.__proto__ || Object.getPrototypeOf(TRefSpan_)).call(this, name || 'RefSpan', desc));

    _this130._silentProp.push('isReference.');
    return _this130;
  }
...
var TScenePage_ = function (_TPanel_6) {
  ...
  function TScenePage_(name, desc) {
    ...
    var _this131 = _possibleConstructorReturn(this, (TScenePage_.__proto__ || Object.getPrototypeOf(TScenePage_)).call(this, name || 'ScenePage', desc));

    _this131._silentProp.push('isScenePage.');
    _this131._defaultProp.noShow = '';
    return _this131;
  }
  ...
  function resetComp(htmlNode) {
    ...
    for (var i = 0, node; node = htmlNode.children[i]; i++) {
      ...
      if (sPath && (sTag == 'PRE' || sTag == 'DIV')) {
        ...
        var namedKey = '',
            registKey = '';
        if (!sKey || typeof sKey != 'string' || sKey.search(/^auto[0-9]+$/) == 0) {
        ...
        if (sTemplate == 'RefDiv') bRet.push(React.createElement(RefDiv__, dProp));else if (sTemplate == 'RefSpan') bRet.push(React.createElement(RefSpan__, dProp));else {
          ...
          if (bSeg.length == 1 && (ch = sTemplate[0]) >= 'a' && ch <= 'z') {
            ...
            var sTag = node.nodeName,
                bChild_ = [];
            if (sTag == 'DIV' || sTag == 'SPAN') bChild_ = scanPreCode(node, sPrefix2); // if no child, result is []
            bChild_.unshift(wtcCls, dProp);
...
var TMarkedDiv_ = function (_TDiv_10) {
  _inherits(TMarkedDiv_, _TDiv_10);

  function TMarkedDiv_(name, desc) {
    _classCallCheck(this, TMarkedDiv_);

    var _this133 = _possibleConstructorReturn(this, (TMarkedDiv_.__proto__ || Object.getPrototypeOf(TMarkedDiv_)).call(this, name || 'MarkedDiv', desc));

    _this133._defaultProp.width = undefined;
    _this133._defaultProp.minWidth = 20;
    _this133._defaultProp.noShow = '';
    _this133._silentProp.push('marked.', 'hasStatic.', 'noSaveChild.');
    return _this133;
  }
...
var TMarkedTable_ = function (_TMarkedDiv_) {
  ...
  function TMarkedTable_(name, desc) {
    ...
    var _this134 = _possibleConstructorReturn(this, (TMarkedTable_.__proto__ || Object.getPrototypeOf(TMarkedTable_)).call(this, name || 'MarkedTable', desc));

    _this134._silentProp.push('markedTable.');
    return _this134;
  }
