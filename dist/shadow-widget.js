...
},{"./emptyFunction":3,"_process":11}],7:[function(require,module,exports){
/*
object-assign
(c) Sindre Sorhus
@license MIT
...
},{"./react_widget":9,"./template":10}],9:[function(require,module,exports){
(function (process){
'use strict';
...
},{"_process":11,"create-react-class":2,"react":undefined,"react-dom":undefined}],10:[function(require,module,exports){
'use strict';
...
utils.waitAll = function () {
  // waitAll(comp1,attr1,comp2,attr2, ... , callback,times)
  var received = [],
      expected = [],
      callback = null,
      times = 1;
  ...
  while (true) {
    var comp = arguments[i],
        sAttr = arguments[i + 1],
        tp = typeof sAttr === 'undefined' ? 'undefined' : _typeof(sAttr);
    if (tp == 'string') {
  ...
  if (!callback) console.log('warning: no callback passed in waitAll()');
...
},{"./react_widget":9,"create-react-class":2,"react":undefined,"react-dom":undefined}],11:[function(require,module,exports){
